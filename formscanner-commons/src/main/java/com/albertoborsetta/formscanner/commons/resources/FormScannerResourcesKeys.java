...
public class FormScannerResourcesKeys {
	...
	public static final String OPEN_IMAGES_ICON_16 = "open_16";

	public static final String SAVE_RESULTS_ICON = "save";

	public static final String RENAME_FILES_ICON = "rename";
	public static final String RENAME_FILES_ICON_16 = "rename_16";

	public static final String ANALYZE_FILES_ICON = "start";
	public static final String ANALYZE_FILES_ICON_16 = "start_16";

	public static final String ANALYZE_FILES_ALL_ICON = "start_all";
	public static final String ANALYZE_FILES_ALL_ICON_16 = "start_all_16";
	...
	public static final String EXIT_ICON_16 = "exit_16";

	public static final String EDIT_ICON = "edit";
	public static final String EDIT_ICON_16 = "edit_16";

	public static final String CONFIG_ICON = "config";
	public static final String CONFIG_ICON_16 = "config_16";

	public static final String HELP_ICON = "help";
	public static final String HELP_ICON_16 = "help_16";
	
	public static final String LANGUAGE_ICON = "spelldialog";
	public static final String LANGUAGE_ICON_16 = "spelldialog_16";
	
	public static final String ABOUT_ICON = "about";
	public static final String ABOUT_ICON_16 = "about_16";
